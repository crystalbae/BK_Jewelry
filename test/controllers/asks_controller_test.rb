...
class AsksControllerTest < ActionController::TestCase
  ...
  test "should create ask" do
    assert_difference('Ask.count') do
      post :create, ask: { content: @ask.content, model: @ask.model, title: @ask.title, writer: @ask.writer }
    end
  ...
  test "should update ask" do
    patch :update, id: @ask, ask: { content: @ask.content, model: @ask.model, title: @ask.title, writer: @ask.writer }
    assert_redirected_to ask_path(assigns(:ask))
  end
